<section id="selling-products" class="product-store bg-light-grey padding-large">
        <div class="container">
          ...
          <ul class="tabs list-unstyled">
            ...
            <li data-tab-target="#shoes" class="tab">Hukum</li>
            <li data-tab-target="#tshirts" class="tab">Manajemen</li>
            <li data-tab-target="#pants" class="tab">Administrasi</li>
            <li data-tab-target="#hoodie" class="tab">Bahasa</li>
            <li data-tab-target="#outer" class="tab">Sastra</li>
            <li data-tab-target="#jackets" class="tab">Modul</li>
            <li data-tab-target="#accessories" class="tab">Teknik</li>
          </ul>
