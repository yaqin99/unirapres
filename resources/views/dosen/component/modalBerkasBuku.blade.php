        ...
        <div class="modal-body">
          <form method="POST" id="form_edit_pengajuan" name="form" enctype="multipart/form-data">
            ...
            <div class="mb-3" >
              ...
              <input type="text"  class="form-control" name="edit_penulis" id="edit_penulis">
            </div>
            <div class="mb-3" >
              <label for="ukuran" class="form-label">Ukuran</label>
              <input type="text"  class="form-control" name="edit_ukuran" id="edit_ukuran">
            </div>
            <div class="mb-3" >
              <label for="jumlah_halaman"  class="form-label">Jumlah Halaman</label>
              <input type="text"  class="form-control" name="edit_jumlah_halaman" id="edit_jumlah_halaman">
            </div>
            {{-- <div class="mb-3">
            ...
            <div class="mb-3" >
              ...
              <input type="datetime-local"  class="form-control" name="edit_tanggal" id="edit_tanggal_buku">
            </div>
            <div class="mb-3" >
              <label for="cover" class="form-label">Cover</label>
              <div class="input-group">
                <input type="text" class="form-control" id="edit_cover"  aria-describedby="button-addon2">
            ...
            <div class="mb-3" >
              ...
              <input type="text"  class="form-control" name="edit_daftar_isi" id="edit_daftar_isi" aria-describedby="button-addon2">
            ...
            <div class="mb-3" >
              ...
              <input type="text"  class="form-control" name="edit_isi_buku" id="edit_isi_buku" aria-describedby="button-addon2">
            ...
            <div class="mb-3" >
              ...
              <textarea class="form-control" name="edit_sinopsis"  id="edit_sinopsis" ></textarea>
            </div>
          </div>
