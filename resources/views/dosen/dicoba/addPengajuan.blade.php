      ...
      <div class="col-3">
        ...
        <form method="POST" action="/addPengajuan" name="form" enctype="multipart/form-data">
          @csrf
          ...
          <div class="mb-3" id="divDaftarIsi">
            ...
            <input type="file"  class="form-control" name="daftar_isi" id="daftar_isi">
          </div>
          <div class="mb-3" id="divIsiBuku">
            <label for="isi_buku" class="form-label">Isi Buku</label>
            <input type="file"  class="form-control" name="isi_buku" id="isi_buku">
          </div>
