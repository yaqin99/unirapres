            ...
            <form action="/addNews" class="signup-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" required name="judul_berita" id="judul_berita"  aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="form-group mb-2">
                    <label for="ukuran" class="text-dark" >Gambar</label>
                    <div class="input-group">
                        <input type="file" class="form-control" required name="gambar" id="gambar"  aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="form-group mb-2">
                    <label for="kategori" class="text-dark" >Deskripsi Gambar</label>
                    <div class="input-group">
                        <input type="text" class="form-control" required name="deskripsi_gambar"   aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="input-group">
                        <input type="datetime-local" class="form-control" required name="tanggal"  aria-describedby="button-addon2">
                    </div>
                </div>
                <div class="form-group mb-2">
                    <label for="sinopsis" class="text-dark">Isi Berita</label>
                    <textarea name="isi_berita" required class="form-control"  ></textarea>
                </div>
                <div class="form-group mb-2">
                    <label for="ukuran" class="text-dark" >Author</label>
                    <div class="input-group">
                        <input type="text" class="form-control" required name="author" id="author"  aria-describedby="button-addon2">
                    </div>
                </div>
            </div>
